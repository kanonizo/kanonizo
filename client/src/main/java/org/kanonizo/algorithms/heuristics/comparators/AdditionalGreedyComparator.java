        ...
        ObjectiveFunction
{
    ...
    private final Set<Line> seenLines = new HashSet<>();
    ...
    public int compare(TestCase o1, TestCase o2)
    {
        ...
        long linesCovered1 = inst.getLinesCovered(o1).stream().filter(l -> !seenLines.contains(l)).count();
        long linesCovered2 = inst.getLinesCovered(o2).stream().filter(l -> !seenLines.contains(l)).count();
    ...
    {
        seenLines.addAll(inst.getLinesCovered(tc));
    }
