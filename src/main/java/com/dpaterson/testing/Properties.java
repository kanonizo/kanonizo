...
public class Properties implements PropertySource {
  ...
  /**
   * Selection for which type of coverage to use. Branch coverage (or decision coverage) looks at statements at which the program can go one of two ways. In these situations, branch coverage
   * represents whether both possible execution paths have been at some stage executed
   *
   */
  ...
  /**
   * The maximum amount of time allowed for execution of a metaheuristic search algorithm
   */
  ...
  /**
   * The maximum number of iterations used for execution of a metaheuristic search algorithm.
   */
  ...
  /**
   * Whether or not to use time as a stopping condition for a metaheuristic search algorithm.
   */
  ...
  /**
   * Whether or not to use iterations as a stopping condition for a metaheuristic search algorithm
   */
  ...
  /**
   * Not intended to be used from command line, so don't have an {@link Parameter} annotation for this. Used to determine whether or not we want the class loader to instrument the classes or not.
   */
